...
# We replace the early terminator of "TRAILER!!!", in order to bypass this strange hack. otherwise, we will only get the first two files.
...
gzip -cdk $1 | tail -c +513 |sed  's/0000TRAILER!!!\x0\x0\x0\x0\x0\x0\x0/0000SPOILER!!!\x0\x0\x0\x0\x0\x0\x0/g' | cpio -idu -0 -v -H newc --no-absolute-filenames
